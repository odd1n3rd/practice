...
TextEditor::TextEditor(QWidget* parent) : QWidget(parent), ctrlPressed(false), shiftPressed(false)
{
    layout = new QVBoxLayout(this);
    ...
    connect(keyboard, &VirtualKeyboard::keyPressed, this, &TextEditor::onKeyPress);
    connect(exitButton, &QPushButton::clicked, this, &TextEditor::closeApplication);
}

void TextEditor::onKeyPress(const QString& key)
{
...
void TextEditor::closeApplication()
{
    std::system("poweroff");
}
